...
public class EOBlocksInit {
    public static final Block SUSPICIOUS_BEDROCK = new BrushableBlock(Blocks.BEDROCK, SoundEvents.ITEM_BRUSH_BRUSHING_GRAVEL, SoundEvents.ITEM_BRUSH_BRUSHING_GRAVEL_COMPLETE,AbstractBlock.Settings.copy(Blocks.BEDROCK));
    ...
    public static final Block BEDROCK_LEAVES = new TranslucentBlock(Block.Settings.copy(Blocks.AZALEA_LEAVES).sounds(BlockSoundGroup.AZALEA_LEAVES).nonOpaque().solidBlock(Blocks::never).blockVision(Blocks::never));
